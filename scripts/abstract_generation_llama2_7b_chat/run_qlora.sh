...
OUTPUT_PATH="output/abstract_generation_qlora_llama2_7b_r64"
...
EVAL_NAME="qlora_llama2_7b_chat_k1_abstract_generation_r64"
...
echo "[Train] Done. Adapter saved at: $OUTPUT_PATH/ft"
