...
RES_MODEL="output/llama-2-7b-chat-hf-pissa"
OUTPUT_PATH="output/abstract_generation_pissa_llama2_7b_r64"
...
EVAL_NAME="pissa_llama2_7b_chat_k1_abstract_generation" 
