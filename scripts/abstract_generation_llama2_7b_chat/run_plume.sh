...
OUTPUT_PATH="output/abstract_generation_llama2_7b_chat/plume"

DATA_DIR="dataset/longlamp_abstract_generation"
TRAIN_FILE="$DATA_DIR/personalized_data_k1.jsonl"

# Your script actual locations
PLUME_SCRIPT="../../plume1_resid_llama.py"


############################
# 1) Train Plume1 (using plume1.py)
############################
echo "[Train] Start Plume1 training with plume1_resid_llama.py..."
